...
switch($a)
{
	case 'list':default://list
		...
		$List = $articles->GetList(array('id','classid','title','filename','addtime','thumb','intro','titlecolor','author','clicks','istop'),$start,$pageListNum,$where,'istop desc,id asc,addtime asc');
