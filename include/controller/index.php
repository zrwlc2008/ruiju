...
$gymldList = $articles->GetList(array('id','classid','title','filename','addtime','titlecolor'),'0','5','classid = 8 and isplay = 1 ','id asc');
$hyzxList = $articles->GetList(array('id','classid','title','filename','addtime','titlecolor'),'0','5','classid = 2 and isplay = 1 ','id asc');
