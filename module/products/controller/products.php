...
switch($a)
{
	case 'list':default://list
		...
		//执行sql
		$List = $products->GetList(array('id','classid','title','filename','addtime','thumb','intro','titlecolor','author','clicks','istop'),$start,$pageListNum,$where,'istop desc,addtime asc,id asc');
	...
	case 'photo'://
		...
		break;
	case 'video':
		$templatefile = $moduleRoot.'templates/'.'video1.php';
		break;
}
//调用
