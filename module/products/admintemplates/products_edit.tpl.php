				...
				<div class="content-box-content">
					...
					<div class="tab-content  default-tab" id="tab1">				
							...
							<fieldset> 
								...
								<p>
									<label>价格</label>
									<input class="text-input medium-input" type="text" id="price" name="price" value="<?php if(!empty($info)) echo $info["price"]; ?>" /> 
								</p>
								<p>
									<label>规格</label>
									<input class="text-input medium-input" type="text" id="standard" name="standard" value="<?php if(!empty($info)) echo $info["standard"]; ?>" /> 
								</p>
