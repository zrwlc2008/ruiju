				...
				<div class="content-box-content">
					...
					<div class="tab-content  default-tab" id="tab1">				
							...
							<fieldset> 
								...
								<p>
									<label>下载地址名称</label>
									<input class="text-input medium-input" type="text" id="dlinkname" name="dlinkname" value="<?php if(!empty($info)) echo $info["dlinkname"]; ?>" /> 
								</p>
								
								<p>
									<label>下载地址</label>
									<input class="text-input medium-input" type="text" id="dlink" name="dlink" value="<?php if(!empty($info)) echo $info["dlink"]; ?>" /> 
									<input class="text-input" type="file" id="dlink_file" name="dlink_file" onchange="return ajaxFileUpload('dlink_file','dlink','dlink_loading');" />
									<span id="dlink_loading"></span>
									<!--<img src="images/loading.gif" id="loading" style="display: none;"> -->
								</p>
