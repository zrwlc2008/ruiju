			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content  default-tab" id="tab1">				
							...
							$classinfo = $downloads_class->GetInfo('',' id='.$value['classid']);
							?>
								<tr>
									<td><input type="checkbox" name="id[]" value="<?php echo $value['id'];?>" /></td>
									<td><?php echo $value['title'];?></td>
									<td><?php echo $classinfo['title'];?></td>
									<td><a href="../?c=downloads&a=show&id=<?php echo $value['id'];?>" target="_blank">前台预览</a> <a href="?c=downloads&a=edit&id=<?php echo $value['id'];?>">编辑</a> <a href="?c=downloads&a=del&id=<?php echo $value['id'];?>" onclick="return confirm('确定删除？');">删除</a></td>
								</tr>
							 <?php
							 }
							 ?>
